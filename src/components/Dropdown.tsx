...
const Dropdown: React.FunctionComponent<DropdownProps> = props => {
  return (
    <div className="flex w-full mt-2">
      ...
      <select className="flex-shrink flex-grow flex-auto text-right leading-normal w-px flex-1 border h-8 border-grey-light rounded rounded-l-none px-3 relative focus:border-blue focus:shadow">
