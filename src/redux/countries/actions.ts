...
export const addSelectedCountries = (countries: Record<string, any>[]): AddSelectedCountriesAction => {
...
export const removeSelectedCountries = (countries: Record<string, any>[]): RemoveSelectedCountriesAction => {
